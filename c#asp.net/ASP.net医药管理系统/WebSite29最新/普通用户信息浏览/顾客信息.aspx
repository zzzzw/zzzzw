<%@ Page Language="C#" AutoEventWireup="true" CodeFile="顾客信息.aspx.cs" Theme="TestTheme"Inherits="普通用户信息浏览_顾客信息" %>
...
<body>
    ...
    <div style="background-image: url('../Image/白色m.jpg'); height: 548px;">
    
        <div style="height: 81px; background-image: url('../Image/123123123.jpg'); width: 589px; margin-left: 252px;">
        </div>
    
        <asp:Button ID="Button1" runat="server" PostBackUrl="~/普通用户信息浏览/经办人信息.aspx" 
            Text="经办人信息" Height="39px" style="margin-left: 0px" Width="166px" />
        <asp:Button ID="Button2" runat="server" PostBackUrl="~/普通用户信息浏览/顾客信息.aspx" 
            Text="顾客信息" Height="37px" Width="154px" ForeColor="Red" />
        <asp:Button ID="Button3" runat="server" PostBackUrl="~/普通用户信息浏览/药品信息.aspx" 
            Text="药品信息" Height="40px" Width="154px" />
        <asp:Button ID="Button4" runat="server" PostBackUrl="~/查看报表.aspx" Text="返回" 
            Height="39px" Width="165px" />
        <asp:Button ID="Button5" runat="server" PostBackUrl="~/Default.aspx" 
            Text="退出登录" Height="38px" Width="176px" />
        <br />
        ...
        &nbsp;
        <div style="width: 761px; height: 308px; margin-left: 179px">
