...
public class studentUpdate extends ActionSupport 
{
	public String execute() throws Exception 
	{
	    ...
	    int i=cdao.updateStudent(new Student(c_id,c_question,c_choiceA,c_choiceB,c_choiceC,c_choiceD,c_answer));
		if(i==0)
		{
			this.addActionMessage("修改成功!");
			ServletActionContext.getRequest().setAttribute("studentshow",new Student(c_id,c_question,c_choiceA,c_choiceB,c_choiceC,c_choiceD,c_answer));
			return "success";
		}
		else
		{
